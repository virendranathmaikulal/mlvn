...
import { MessageCircle, Send, Users, ShoppingCart } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Order Leads</CardTitle>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => navigate('/whatsapp/conversations')}>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
